...
<!-- <form method="post" action="<?php echo site_url('Project/InsertProject')?>"  enctype='multipart/form-data'> -->
	<form id="ProjectForm" action="<?php echo site_url('Project/InsertProjectTeacher')?>" name="ProjectForm" method="post" enctype='multipart/form-data'>
    ...
    margin-right: auto; border: 1px solid #D8D9DC;">
			<div class="header" style="margin-bottom: 20px;">
				<img src="" alt="">
				<h2 style="">สร้างโครงการของอาจารย์</h2>
				<hr>
			</div>
			...
			<div class="Login">
				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="form-group">
							<input onChange="CheckUsernameTeacher()" type="text" class="form-control" name="Res" id="Res" placeholder="ชื่อ - นามสกุล"
								style="max-width: 400px ;background: #fcfcfc; color: #000 ; margin-bottom: 20px" required>
						</div>
                ...
                <div class="row">
					<div class="col-md-8">
						<p>งบประมาณโครงการ</p>
						<div class="form-group">
							<input type="text" class="form-control" name="Money" id="Money" placeholder="ระบุงบประมาณโครงการ"
								style="max-width: 400px ;background: #fcfcfc; color: #000 ; margin-bottom: 20px" required>
						</div>
					</div>
				</div>
