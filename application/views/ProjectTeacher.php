<div class="container">
	...
	<form id="ProjectForm" action="<?php echo site_url('Project/InsertProjectTeacher')?>" name="ProjectForm"
    ...
    margin-right: auto; border: 1px solid #D8D9DC;">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<select name="BranchRes" id="BranchRes" style="height: 35px;" required onChange="Change_TypeResTeacher()">
