...
?>
		...
		<form method="post" action="<?php echo site_url('AddLoan/AddData/'.$idRepo)?>" enctype='multipart/form-data'>
			<h2 style="font-weight: 0px;">เพิ่มข้อมูลค่าใช้จ่ายในกิจกรรม <?php echo '"'.$InAc['Name_Activities'].'"'?>
			</h2>
			<hr>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<input type="text" class="form-control" id="Name" name="Name" placeholder="ระบุรายการ" required>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<input type="number" class="form-control" min="0" max="<?php echo $showpayloan;?>" id="Money"
							name="Money" placeholder="10000" required>
					</div>
				</div>
			</div>
			...
			<button type="button" class="btn btn-primary" data-toggle="modal"
				data-target="#AlertMoney">ไปหน้ากิจกรรม</button>
			<?php }?>
		</form>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<h2 style="text-align: center;">
							เนื่องจากเหลือจำนวนเงินของกิจกรรมที่ยังไม่ระบุค่าใช้จ่ายเหลืออยู่</h2>
		...
		<div class="ct-example tab-content tab-example-result" style="margin: auto; margin-top: 62px; padding: 1.25rem;
			...
			<div id="inputs-alternative-component" class="tab-pane tab-example-result fade active show" role="tabpanel"
				...
				<h2 class="" style="font-size: 30px;">ค่าใช้จ่ายในกิจกรรม <?php echo '"'.$InAc['Name_Activities'].'"'?>
				</h2>
				<hr>
		...
		<div class="ct-example tab-content tab-example-result" style="margin: auto; margin-top: 62px; padding: 1.25rem;
			...
			<div id="inputs-alternative-component" class="tab-pane tab-example-result fade active show" role="tabpanel"
				...
				<h2 style="font-size: 25px;"> งบประมาณที่ยังไม่ได้ระบุค่าใช้จ่าย : :
					<?php echo number_format($showshowbgstring, 2);?> บาท</h2>
					...
					<table class="table align-items-center table-flush" id="Filetable">
						...
						<tbody>
							...
							<tr>
								...
								<td class="">
									...
									<div>
										...
										<?php }?>
										<div class="modal fade" id="<?php echo $datadetail['Name_Loan'];?>"
												...
												<div class="modal-content" style="color: #2d3436;">
													...
													<div class="modal-body">
														<form
															...
															<input type="hidden"
																id="<?php echo $datadetail['ID_Loan'];?>" name="ID_Loan"
							...
							<tr>
								...
								<td>
									<h2 style="text-align: center; font-weight:bold"><?php echo number_format($i, 2);?>
									</h2>
								</td>
							</tr>
						</tbody>
