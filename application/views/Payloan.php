                    ...
                    <div class="table-responsive">   
                                        <table class="table align-items-center table-flush" id="Filesearch">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                            <span class="badge badge-dot mr-4">
                                                                <a href="<?php echo site_url(); ?>Payloan/Approve/<?php echo $data['ID_Activities'];?>"  class="btn btn mb-3" style="background-color: #00a81f; color: #fff;">อนุมัติ</a>              
                                                            </span>
                                                        </td>  
                                                        <td>
                                                            <span class="badge badge-dot mr-4">
                                                                <a href="<?php echo site_url(); ?>Payloan/Eject/<?php echo $data['ID_Activities'];?>"  class="btn btn mb-3" style="background-color: #db0f2f; color: #fff;">ไม่อนุมัติ</a>              
                                                            </span>
                                                        </td>  
                                            </tr>
                                            <?php } endif; ?> 
