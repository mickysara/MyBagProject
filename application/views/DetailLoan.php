...
$result = $this->db->query("SELECT * FROM LoanDetail WHERE ID_Loan = $idRepo") ;           
	...
	<div class="ct-example tab-content tab-example-result" style="margin: auto; margin-top: 62px; padding: 1.25rem;
		...
		<div id="inputs-alternative-component" class="tab-pane tab-example-result fade active show" role="tabpanel"
			...
			<h2 class="" style="font-size: 30px;">ยังไม่มีรายละเอียดค่าใช้จ่ายของ: <?php echo '"'.$showshowbg['Name_Loan'].'"'?></h2>
			<hr>
	...
	<div class="ct-example tab-content tab-example-result" style="margin: auto; margin-top: 62px; padding: 1.25rem;
		...
		<div id="inputs-alternative-component" class="tab-pane tab-example-result fade active show" role="tabpanel"
			aria-labelledby="inputs-alternative-component-tab">
			<h2 class="" style="font-size: 30px;">รายละเอียดค่าใช้จ่าย: <?php echo '"'.$showshowbg['Name_Loan'].'"'?></h2>
			<hr>
			<button type="button" class="btn btn" style="margin-bottom: 20px; background-color: #00a81f; color: #fff;"
				data-toggle="modal" data-target="#AddLoanDetail">
				เพิ่มสลิปในรายการ
			...
			<td>
				<span class="badge badge-dot mr-4">
					<a href="<?php echo base_url("slipclear/". $data['Image']) ?>" class="btn btn mb-3 Doc"
    ...
    <div class="modal fade" id="<?php echo $data['Detail'];?>" tabindex="-1"
									role="dialog" aria-labelledby="<?php echo $data['Detail'];?>"
									aria-hidden="true">
									<div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
										<div class="modal-content" style="color: #2d3436;">
											...
											<div class="modal-body">
												<form
													action="<?php echo base_url('AddLoan/EditDetailLoan/').$data['ID_LoanDetail']; ?>"
													...
													<input type="hidden" id="<?php echo $data['ID_LoanDetail'];?>"
														name="ID_LoanDetail" value="<?php echo $data['ID_LoanDetail'];?>">
